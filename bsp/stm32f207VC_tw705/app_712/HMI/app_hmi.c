...
/* HMI  thread */
ALIGN(RT_ALIGN_SIZE) 
char HMI_thread_stack[4096]; // 4096     
...
void  speaker_on(u8 value)
{
 ...
 FINSH_FUNCTION_EXPORT(speaker_on, speaker_on);    